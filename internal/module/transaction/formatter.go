...
func FormatCampaignTransaction(transaction transactionEntity.Transaction) CampaignTransactionFormatter {
...
func FormatCampaignTransactions(transactions []transactionEntity.Transaction) []CampaignTransactionFormatter {
...
func FormatUserTransaction(transaction transactionEntity.Transaction) UserTransactionFormatter {
...
func FormatUserTransactions(transactions []transactionEntity.Transaction) []UserTransactionFormatter {
	formatter := []UserTransactionFormatter{}
...
func FormatTransaction(transaction transactionEntity.Transaction) TransactionFormatter {
